...
where $P' = \bigcup_{o \in \C{T}{r}{n}} P(o)$. Moreover, since $P(n) = \pi(n) \cup P'$ and $\Phi(n) = \prod_{o \in \C{T}{r}{n}} \Phi(o)$ this completes the induction.
...
%     Let $\phi$ be a CNF formula, $(T, r, \gamma, \pi)$ be a project-join tree of $\phi$, $W$ be a literal-weight function over $\vars(\phi)$, and $n \in \V{T}$.
%      Then:
% \end{lemma}
% \begin{proof}
% We prove this by structural induction on $n \in \V{T}$. 
    
% \end{proof}

% Theorem \ref{thm_valuation_wmc} is a corollary of a more general statement on the valuation of nodes in a project-join trees:
