...
A different heuristic is \textdef{minimal fill-in} \cite{dechter03}.
...
This heuristic corresponds to \textdef{bucket elimination} \cite{dechter99}, so we call it the \Be{} heuristic.
...
We consider two possible heuristics to use for $\chosenCluster$ that satisfy the conditions of Theorem \ref{thm_csp_jt}: \heuristic{List} and \heuristic{Tree} \cite{DPV20}.
