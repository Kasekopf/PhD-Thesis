...
Despite the theoretical difficulty of discrete integration, a variety of discrete integration tools (called \emph{counters}) exist that can handle large sets of constraints and so solve large, useful applied problems. The earliest counters, e.g. \tool{CDP} \cite{birnbaum1999good}, were based on search.
