...
To answer RQ1, we build two implementations of the planning phase: \Htb{} (Heuristic Tree Builder, based on \tool{ADDMC} \cite{DPV20,phan2019weighted}) and \Lg{} (Line Graph, based on Chapter \ref{ch:tensors}).
...
To answer RQ2, we build two implementations of the execution phase: \Dmc{} (Diagram Model Counter, based on \tool{ADDMC} \cite{DPV20,phan2019weighted}) and \Tensor{}.
