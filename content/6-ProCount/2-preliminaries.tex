...
% \end{theorem}
% Early projection is a key technique in symbolic computation in many settings, e.g. database-query optimization \cite{KV00}, symbolic model checking \cite{burch1991symbolic}, satisfiability solving \cite{pan2005symbolic}, and model counting \cite{DPV20}.
