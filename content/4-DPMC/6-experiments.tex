...
To answer RQ1, we build two implementations of the planning phase: \Htb{} (Heuristic Tree Builder, based on \cite{DPV20}) and \Lg{} (Line Graph, based on Chapter \ref{ch:tensors}).
