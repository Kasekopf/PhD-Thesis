...
Organizationally, note that we discuss the execution stage in Section \ref{sec:tensors:execution} before we discuss the planning stage in Section \ref{sec:tensors:planning}. 
