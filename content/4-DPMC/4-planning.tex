...
using constraint-satisfaction heuristics (in \cite{DPV20}) and using tree decompositions (in \cite{fichte2020exploiting}). %TODO: cite more tree decomposition tools
