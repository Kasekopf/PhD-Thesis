...
% ;{ \color{blue} for example, within the planning method \textbf{LG} the graph $\Line{\struct{N}}$ will contain a clique of $r$ vertices and so will have treewidth at least $r-1$. } % diff
