...
This breakdown enables us to study and compare different planning algorithms, different execution environments, and the interplay between planning and execution.
Such a study is the main focus of this chapter. %TODO: expand the details
...
\begin{enumerate}
    ...
    \footnote{An \emph{anytime} algorithm outputs better and better solutions the longer it runs.} tree-decomposition tools \cite{MPPV04,AMW17,HS18,Tamaki17} and find tree-decomposition tools to outperform constraint-satisfaction heuristics. %TODO: Cite original tree-decomposition paper instead of MPPV04?
