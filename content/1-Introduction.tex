...
In fact, every problem in the polynomial hierarchy can be answered by a single \#SAT query. %TODO: Cite Toda. 
...
%TODO: Reduction from weighted to unweighted
...
Modern solverslike \tool{cachet} \cite{SBK05} and \tool{SharpSAT} \cite{Thurley2006} follow this approach.
...
A third class of counters \cite{CW16,FHMW17,FHWZ18,FHZ19,DPV20,fichte2020exploiting} are based on dynamic programming. % \cite{BDP09,SS10,jegou2016improving}
