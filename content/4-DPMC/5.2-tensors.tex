...
In order to incorporate tensors in our project-join-tree-based framework, we take a different strategy that uses copy tensors. %TODO: Copy tensors were defined in Ch 2 with COPY instead of \blacksquare
