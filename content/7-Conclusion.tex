...
\section{Future Work}
The framework introduced in this thesis is just the next step towards developing practical tools for automated reasoning.
We end with a list of several open directions to improve our framework and to apply our framework in broader context.
